...
export declare function choice<T>(...params: T[]): IEnumerable<T>;
export declare function cycle<T>(...params: T[]): IEnumerable<T>;
...
export declare function from(): IEnumerable<any>; // empty
export declare function from<T>(obj: IEnumerable<T>): IEnumerable<T>;
export declare function from(obj: number): IEnumerable<number>;
export declare function from(obj: boolean): IEnumerable<boolean>;
...
export declare function matches<T>(input: string, pattern: string, flags?: string): IEnumerable<T>;
...
export declare function repeatWithFinalize<T>(initializer: () => T, finalizer: (element) => void): IEnumerable<T>;
...
export declare function defer<T>(enumerableFactory: () => IEnumerable<T>): IEnumerable<T>;
...
interface IEnumerable<T> {
    ...
    traverseDepthFirst<TResult>(func: (element: T) => IEnumerable): IEnumerable<T>;
    traverseDepthFirst<TResult>(func: (element: T) => IEnumerable, resultSelector?: (element: T, nestLevel: number) => TResult): IEnumerable<TResult>;
