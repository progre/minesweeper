...
class MineWorld {
    ...
    constructor(
        ...
        this.landform.getTileChunk(Coord.fromNumber(-1, -1));
        this.landform.getTileChunk(Coord.fromNumber(0, -1));
        this.landform.getTileChunk(Coord.fromNumber(-1, 0));
        this.landform.getTileChunk(Coord.fromNumber(0, 0));
    }
